/* watersmokeunit.h -- Process unit 'smoke' when damaged for underwaterunits
** based on original SmokeUnit.h file
**
** by Nikola Genkov - nik@royal.bg, nikola_g@yahoo.com
*/
