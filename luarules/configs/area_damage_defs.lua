...
local weapons = {
	...
	--junos
	ajuno_juno_pulse = { radius = 950, damage = 0, duration = 900, rangeFall = 0.8, timeFall = 0.1, scoutDmg = 60},
	cjuno_juno_pulse = { radius = 950, damage = 0, duration = 900, rangeFall = 0.8, timeFall = 0.1, scoutDmg = 60},
	tlljuno_juno_pulse = { radius = 950, damage = 0, duration = 900, rangeFall = 0.8, timeFall = 0.1, scoutDmg = 60},
