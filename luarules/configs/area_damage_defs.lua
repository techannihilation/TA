...
local weapons = {
	...
	--mortor_canon
	amortor_mortor_canon =  { radius = 95, damage = 200, duration = 60, rangeFall = 0.25, timeFall = 0.8, allyScale = 0.5, teamScale = 0.25},
	cmortor_mortor_canon =  { radius = 95, damage = 200, duration = 60, rangeFall = 0.25, timeFall = 0.8, allyScale = 0.5, teamScale = 0.25},
	tllmortor_mortor_canon =  { radius = 95, damage = 200, duration = 60, rangeFall = 0.25, timeFall = 0.8, allyScale = 0.5, teamScale = 0.25},
