...
local weapons = {
	...
	--junos
	ajuno_juno_pulse = { radius = 950, damage = 4, duration = 240, rangeFall = 0.8, timeFall = 0.1, scoutScale = 15},
	cjuno_juno_pulse = { radius = 950, damage = 4, duration = 240, rangeFall = 0.8, timeFall = 0.1, scoutScale = 15},
	tlljuno_juno_pulse = { radius = 950, damage = 4, duration = 240, rangeFall = 0.8, timeFall = 0.1, scoutScale = 15},
