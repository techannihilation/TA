		...
		weaponLightDefs = {
			...
			["arm_starburst"] = {
				projectileLightDef = {
					...
					explosionLightDef = {
					diffuseColor      = {0.1,                   0.2,                   1.2                  },
					specularColor     = {0.1 * rgbSpecMults[1], 0.2 * rgbSpecMults[2], 1.2 * rgbSpecMults[3]},
					radius            = 185.0,
					priority          = 3 * 10 + 1,
			...
			["tll_starburst"] = {
				projectileLightDef = {
					...
					explosionLightDef = {
					diffuseColor      = {1.1,                   0.1,                   1.1                  },
					specularColor     = {1.1 * rgbSpecMults[1], 0.1 * rgbSpecMults[2], 1.1 * rgbSpecMults[3]},
					radius            = 185.0,
					priority          = 3 * 10 + 1,
					ttl               = 2.5 * Game.gameSpeed,
					decayFunctionType = {0.0, 0.0, 0.0},
