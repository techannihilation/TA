...
local airbaseDefIDs = {
   ...
   [UnitDefNames["armhcar"].id] = 450,
   --Core
   [UnitDefNames["corasp"].id] = 350,
   [UnitDefNames["corcarry"].id] = 450,
   [UnitDefNames["corhcar"].id] = 450,
   --The Lost Legacy
   [UnitDefNames["tllasp"].id] = 350,
   [UnitDefNames["tllaspns"].id] = 350,
   [UnitDefNames["tllgiant"].id] = 450,
}

local snapDist = 350 -- default snap distance, if not found in table
