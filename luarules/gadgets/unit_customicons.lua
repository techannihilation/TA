...
function gadget:Initialize()
  ...
  Spring.AddUnitIcon("rumad_gala.user", "icons/rumad_gala.png", 3.5)
  ...
  for udid, ud in pairs(UnitDefs) do
    if ud ~= nil then
      ...
      elseif ud.name == "rumad_gala" then
        Spring.SetUnitDefIcon(udid, "rumad_gala.user")
      ...
      --T5 Crusers
      elseif (ud.name == "arm_broadside") or (ud.name == "cdevastator") or (ud.name == "tllzeppelin") or (ud.name == "gok_apocalypse") or (ud.name == "rumad_jafa") or (ud.name == "rumad_lago") then
