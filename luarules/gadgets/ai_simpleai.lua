...
local function SimpleBuildOrder(cUnitID, building)
	...
	for b2 = 1,20 do
		...
		if #units > 1 then
			...
			local isCommander = (UnitDefs[refDefID].name == "armcom" or UnitDefs[refDefID].name == "corcom" or UnitDefs[refDefID].name == "gok_com" or UnitDefs[refDefID].name == "rumad_com" or UnitDefs[refDefID].name == "tllcom" or UnitDefs[refDefID].name == "talon_com")
