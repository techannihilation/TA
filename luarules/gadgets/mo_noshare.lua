...
function gadget:AllowResourceTransfer(oldTeam, newTeam, type, amount)
  if enabled == 1 then
    SendMessageToTeam(oldTeam, "Resource sharing to allies and enemies has been disabled.")
...
function gadget:AllowUnitTransfer(unitID, unitDefID, oldTeam, newTeam, capture)
    if enabled == 1 then
    SendMessageToTeam(oldTeam, "Unit sharing to allies and enemies has been disabled.")
