...
local NO_LAND_DAMAGE = {
  ...
  [WeaponDefNames['coruppercut_armsmart_torpedo'].id] = true,
  [WeaponDefNames['armserpent_armserpent_weapon'].id] = true,
  [WeaponDefNames['coruppercut_armserpent_weapon'].id] = true,
