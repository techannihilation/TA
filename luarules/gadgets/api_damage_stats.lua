...
function gadget:UnitCreated(_, unitDefID, teamID, _)
...
function gadget:UnitDamaged(unitID, unitDefID, unitTeam, damage, _, _, _, _, attackerDefID, attackerTeam)
...
function gadget:UnitDestroyed(_, unitDefID, unitTeam, _, attackerDefID, attackerTeam)
    if not attackerDefID then return end
    if not unitDefID then return end
    if not info[attackerDefID] then return end
    if not info[unitDefID] then return end
