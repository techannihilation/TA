...
function GuessOne(_, _, xmin, zmin, xmax, zmax, startPointTable)
...
function GuessTwo(_, _, xmin, zmin, xmax, zmax, startPointTable) --TODO: make this more efficient, atm it akes 1-2 sec to run
