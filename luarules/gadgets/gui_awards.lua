...
local econUnitDefIDs = { --better to hardcode these since its complicated to pick them out with UnitDef properties
  ...
  UnitDefNames.corbhmth1.id,
	...
	UnitDefNames.tllwin.id,
	UnitDefNames.tllwin1.id,
  ...
  UnitDefNames.armufus.id,
	UnitDefNames.corefus.id,
	UnitDefNames.corufus.id,
	UnitDefNames.tllefus.id,
  UnitDefNames.tllufus.id,
  UnitDefNames.tlluwefusion.id,
  UnitDefNames.talon_solar.id,
  UnitDefNames.talon_advsolar.id,
  UnitDefNames.talon_win.id,
  UnitDefNames.talon_win1.id,
  ...
  UnitDefNames.talon_uwefus.id,
  UnitDefNames.talon_ufus.id,
  UnitDefNames.talon_pyroclastic.id,
  UnitDefNames.gok_solar.id,
  UnitDefNames.gok_advsolar.id,
  UnitDefNames.gok_win.id,
  UnitDefNames.gok_win1.id,
	UnitDefNames.gok_gen.id,
	UnitDefNames.gok_fusion.id,
	UnitDefNames.gok_efusion.id,
	UnitDefNames.gok_sfusion.id,
	UnitDefNames.gok_uwfusion.id,
  UnitDefNames.gok_geo.id,
  UnitDefNames.gok_geo_mini.id,
  UnitDefNames.gok_mohogeo.id,

  UnitDefNames.gok_egeo.id,
  UnitDefNames.talon_egeo.id,
  UnitDefNames.tllegeo.id,

  UnitDefNames.rumad_gen.id,
  UnitDefNames.rumad_fusion.id,
  UnitDefNames.rumad_sfusion.id,
  ...
  UnitDefNames.rumad_geo.id,
  UnitDefNames.rumad_mohogeo.id,
  ...
  UnitDefNames.tllmetalmakerlvl4.id,
  ...
  UnitDefNames.gok_makr.id,
  UnitDefNames.gok_fmkr.id,
  UnitDefNames.gok_makr1.id,
  UnitDefNames.gok_metalmakerlvl2.id,
  UnitDefNames.gok_metalmakerlvl3.id,
  UnitDefNames.gok_metalmakerlvl4.id,
  UnitDefNames.rumad_metalmakerlvl1.id,
  UnitDefNames.rumad_metalmakerlvl2.id,
  UnitDefNames.rumad_metalmakerlvl3.id,
}
