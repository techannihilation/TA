return {
	talon_sp = {
		...
		unitname = "talon_sp",
		workertime = 800,
		yardmap = "oooooooooooooooooo oooooooooooooooooo oooooooooooooooooo oooooooooooooooooo oooooooooooooooooo oooooooooooooooooo oooooooooooooooooo oooooooooooooooooo",
		buildoptions = {
			[1] = "talon_csat",
			[2] = "sat_radar",
			[3] = "sat_antiair",
