...
Def.cormachn.featureDefs.DEAD.damage = 0.6000 * Def.cormachn.maxDamage
Def.cormachn.featureDefs.DEAD.description = Def.cormachn.name .. [[ Wreckage]]
Def.cormachn.featureDefs.DEAD.metal = 0.8000 * Def.cormachn.buildCostMetal
Def.cormachn.featureDefs.HEAP.damage = 0.3600 * Def.cormachn.maxDamage
Def.cormachn.featureDefs.HEAP.description = Def.cormachn.name .. [[ Dead]]
Def.cormachn.featureDefs.HEAP.metal = 0.6400 * Def.cormachn.buildCostMetal
