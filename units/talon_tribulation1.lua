return {
	talon_tribulation1 = {
		...
		description = "Long Range Anti-Nuke Tank",
		energymake = 50,
		energystorage = 1000,
		...
		objectname = "talon_tribulation1",
		radaremitheight = 25,
		script = "talon_tribulation.cob",
