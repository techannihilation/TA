return {
	talon_podlab = {
		...
		workertime = 1600,
		yardmap = "oooccccccccccccooo oooccccccccccccooo oooccccccccccccooo oooccccccccccccooo oooccccccccccccooo oooccccccccccccooo oooccccccccccccooo oooccccccccccccooo oooccccccccccccooo oooccccccccccccooo oooccccccccccccooo oooccccccccccccooo",
		buildoptions = {
			[1] = "talon_cpod",
			--[2] = "talon_expanse",
			[3] = "talon_archon",
