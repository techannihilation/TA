return {
	armcom6 = {
		...
		autoheal = 12.5,
		brakerate = 1.2,
		buildcostenergy = 678500,
		buildcostmetal = 40802,
		builddistance = 300,
		builder = true,
		...
		canreclamate = 1,
		canstop = 1,
		category = "LEVEL2 ALL COMMANDER CONSTR HUGE MOBILE NOTDEFENSE NOTHOVERNOTVTOL NOTSUB NOTSUBNOTSHIP NOTVTOL WEAPON SURFACE UNDERWATER",
		cloakcost = 100,
		cloakcostmoving = 700,
