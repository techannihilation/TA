...
Def.core_intimidator.featureDefs.CORINT_DEAD.damage = 0.6000 * Def.core_intimidator.maxDamage
Def.core_intimidator.featureDefs.CORINT_DEAD.metal = 0.8000 * Def.core_intimidator.buildCostMetal
Def.core_intimidator.featureDefs.CORINT_HEAP.damage = 0.3600 * Def.core_intimidator.maxDamage
Def.core_intimidator.featureDefs.CORINT_HEAP.metal = 0.6400 * Def.core_intimidator.buildCostMetal
