return {
	core_hexapod_lab = {
		...
		canpatrol = true,
		canstop = 1,
		category = "ALL NOTDEFENSE NOTHOVERNOTVTOL NOTMOBILE NOTSUB NOTSUBNOTSHIP NOTVTOL NOTWEAPON PLANT SURFACE SURFACE",
		corpse = "heap",
		description = "Produces T4.5 Units",
		energystorage = 1400,
		energyuse = 0,
