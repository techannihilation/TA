...
Def.corbuzz2.featureDefs.CORBUZZ_HEAP.damage = 0.6000 * Def.corbuzz2.maxDamage
Def.corbuzz2.featureDefs.CORBUZZ_HEAP.metal = 0.8000 * Def.corbuzz2.buildCostMetal
Def.corbuzz2.featureDefs.DEAD.damage = 0.3600 * Def.corbuzz2.maxDamage
Def.corbuzz2.featureDefs.DEAD.metal = 0.6400 * Def.corbuzz2.buildCostMetal
