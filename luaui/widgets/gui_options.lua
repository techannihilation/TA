...
--]]
		...
		{id="lupsdynamic", group="gfx", name="Dynamic Lups particle", type="bool", value=tonumber(Spring.GetConfigInt("DynamicLups",0) or 1), description='Auto adjust lups effect level depening on FPS'},
