			...
			if ud and ud.primaryWeapon then
				...
				if did_shot then
					...
					if commands and commands[1] and commands[1].id==CMD_ATTACK and commands[2] then
						...
						for i=2,#commands do
							if commands[i].id ~= CMD_WANTED_SPEED then
