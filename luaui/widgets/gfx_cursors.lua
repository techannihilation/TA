...
local cursorSets = {'old', 'ota_160'}
local Settings = {}
Settings['defaultCursorSet'] = 'old'
...
function widget:Initialize()
	...
	WG['cursors'] = {}
	WG['cursors'].getcursor = function() return Settings['cursorSet'] end
	WG['cursors'].getcursorsets = function() return cursorSets end
...
function SetCursor(cursorSet)
	local cursorNames = {'cursornormal', 'cursorareaattack', 'cursorattack', 'cursorattack', 'cursorbuildbad', 'cursorbuildgood', 'cursorcapture', 'cursorcentroid', 'cursorwait', 'cursortime', 'cursorwait', 'cursorunload', 'cursorwait', 'cursordwatch', 'cursorwait', 'cursordgun', 'cursorattack', 'cursorfight', 'cursorattack', 'cursorgather', 'cursorwait', 'cursordefend', 'cursorpickup', 'cursorrepair', 'cursorrevive', 'cursorrepair', 'cursorrepair', 'cursormove', 'cursorpatrol', 'cursorreclamate', 'cursorselfd', 'cursornumber', 'cursorsettarget', 'cursorupgmex'}
...
function widget:SetConfigData(data)
	if data and type(data) == 'table' then
		-- correct legacy settings
		if 'number' == type(data['cursorSet']) then
			data['cursorSet'] = 'bar'

			if data['cursorSet'] == 1 then
				data['cursorSet'] = 'old'
			end
		end
