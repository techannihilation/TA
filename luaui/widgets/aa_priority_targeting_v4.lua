...
function widget:DrawScreen()
    ...
    glColor(1, 1, 1, 0.9)
    local label = widgetEnabled and "AA Priority Targeting: ON" or "AA Priority Targeting: OFF"
    if widgetEnabled and airRaidActive then
        label = label .. " (RAID)"
    end
    glText(label, guiX + 8, guiY + guiH / 2 - 6, 13, "on")
end
