 ...
 ["tlldischarge"] = {
  ...
  ["tlluberweb"] = {
    unit_sparkles = {
      ...
      properties = {
        airdrag            = 0.95,
        colormap           = [[0 0 0 0	0.9 0.9 0.2 0.01  0.6 0.6 0.1 0.01	  0.3 0.3 0 0.01	  0.1 0.1 0.1 0.01	  0 0 0 0.01]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 0,
        emitvector         = [[0, 0, 0]],
  ...
  ["tlluber_glow"] = {
     glow = {
      ...
      properties = {
        airdrag            = 1,
        alwaysvisible      = true,
	      colormap           = [[0.9 0.9 0.2 0.01    0.6 0.6 0.1 0.01              0 0 0 0.01]],
	      directional        = true,
        emitrot            = 0,
        emitrotspread      = 0,
        emitvector         = [[0, 0, 0]],
   ...
   ["tll_spray_muzzle"] = {
     glow = {
      ...
      properties = {
        airdrag            = 1,
        alwaysvisible      = true,
        colormap           = [[0.8 0.8 0.1 0.01    0.55 0.55 0.05 0.01              0 0 0 0.01]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 0,
        emitvector         = [[0, 0, 0]],
  ...
  ["tll_muzzle"] = {
   unit_sparkles = {
     ...
     properties = {
       airdrag            = 0.95,
       colormap           = [[0 0 0 0	0.6 0.6 0.9 0.2	  0.9 0.9 0.2 0.4	  0.6 0.6 0.1 0.2	  0.1 0.1 0.1 0.1	  0 0 0 0.01]],
       directional        = true,
       emitrot            = 0,
       emitrotspread      = 270,
       emitvector         = [[0, 0.1, 0]],
     ...
     properties = {
       airdrag            = 1,
       alwaysvisible      = true,
       colormap           = [[0.9 0.9 0.2 0.01    0.1 0.1 1 0.01              0 0 0 0.01]],
       directional        = true,
       emitrot            = 0,
       emitrotspread      = 0,
       emitvector         = [[0, 0, 0]],
