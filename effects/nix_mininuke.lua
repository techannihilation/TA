...
return {
  ["nix_mininuke"] = {
   ...
   glow = {
     ...
     explosionball = {
      ...
      properties = {
        airdrag            = 0.98,
        colormap           = [[1 1 1 1  1 1 1 .2  1 1 1 0.6   1 1 1 .4 	0.6 0.3 .3 .1	0 0 0 0.01]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 10,
        emitvector         = [[0, 1, 0]],
    ...
    explosionball1 = {
      ...
      properties = {
        airdrag            = 0.98,
        colormap           = [[1 1 1 1  1 1 1 .2  1 1 1 0.6   1 1 1 .4 	0.6 0.3 0 .1	0 0 0 0.01]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 360,
        emitvector         = [[0, 1, 0]],
      ...
      properties = {
        airdrag            = 0.96,
        colormap           = [[ 0 0 0 0.00	 0 0 0 0.00	 0.1 0.1 0.1 0.2		0.1 0.1 0.1 0.4		0.1 0.1 0.1 0.3		0.1 0.1 0.1 0.2		 0 0 0 0.00]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 0,
        emitvector         = [[0, 1, 0]],
  ...
  ["fireball_piece"] = {
    rocks = {
      ...
      properties = {
        airdrag            = 0.97,
        colormap           = [[1 1 1 .2    1 1 1 0.5	0.6 0.3 0 .1 	0 0 0 0.01]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 360,
        emitvector         = [[0, 1, 0]],
