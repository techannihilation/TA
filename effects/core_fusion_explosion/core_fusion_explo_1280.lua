...
return {
  ["core_fusion_explo_1280"] = {
   ...
   SmokeySpawner = {
      ...
      properties = {
        delay              = [[15 i1]],
        explosiongenerator = [[custom:Smoke_fus_1280]],
     ...
     FireballSpawner = {
      ...
      properties = {
        delay              = 0,
        explosiongenerator = [[custom:fireball_expl_fus_1280]],
        pos                = [[0, 0, 0]],
      },
    },
     SpikeSpawner = {
      ...
      properties = {
        delay              = [[0]],
        explosiongenerator = [[custom:fus_spike_1280]],
        pos                = [[0, 0, 0]],
      },
    },
     trails = {
      ...
      properties = {
        delay              = 0,
        explosiongenerator = [[custom:Fusion_Explo_Trail_1280]],
        pos                = [[0,0,0]],
      },
    },
  },
  
   ["Fusion_Explo_Trail_1280"] = {
    Spark = {
      air                = true,
      class              = [[CSimpleParticleSystem]],
      count              = 2,
  ...
  ["fireball_expl_fus_1280"] = {
    ...
    fwoosh = {
      ...
      properties = {
        delay              = [[30  i1]],
        explosiongenerator = [[custom:fireball_smoke_1280]],
        pos                = [[-100 r100,0 r50, -50 r100]],
      },
    },
    fireball = {
      air                = true,
      ...
      properties = {
        delay              = [[30  i1]],
        explosiongenerator = [[custom:fireball_heat_1280]],
