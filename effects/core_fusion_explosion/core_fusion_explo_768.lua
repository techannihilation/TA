...
return {
  ["core_fusion_explo_768"] = {
   ...
   SmokeySpawner = {
      ...
      properties = {
        delay              = [[15 i1]],
        explosiongenerator = [[custom:Smoke_fus_768]],
     ...
     FireballSpawner = {
      ...
      properties = {
        delay              = 0,
        explosiongenerator = [[custom:fireball_expl_fus_768]],
        pos                = [[0, 0, 0]],
      },
    },
     SpikeSpawner = {
      ...
      properties = {
        delay              = [[0]],
        explosiongenerator = [[custom:fus_spike_768]],
        pos                = [[0, 0, 0]],
      },
    },
     trails = {
      ...
      properties = {
        delay              = 0,
        explosiongenerator = [[custom:Fusion_Explo_Trail_768]],
        pos                = [[0,0,0]],
      },
    },
  },
  
   ["Fusion_Explo_Trail_768"] = {
    Spark = {
      air                = true,
      class              = [[CSimpleParticleSystem]],
      count              = 2,
  ...
  ["fireball_expl_fus_768"] = {
    ...
    fwoosh = {
      ...
      properties = {
        delay              = [[30  i1]],
        explosiongenerator = [[custom:fireball_smoke_768]],
    ...
    fireball = {
      ...
      properties = {
        delay              = [[30  i1]],
        explosiongenerator = [[custom:fireball_heat_768]],
        pos                = [[-50 r100,0 r50, -50 r100]],
      },
    },
  },
