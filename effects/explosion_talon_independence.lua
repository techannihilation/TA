...
return {
  ["explosion_talon_independence"] = {
    smoke = {
      ...
      properties = {
        airdrag            = 1,
        colormap           = [[0 0 0 0  0 0.1 0.9 1     0.7 .7 0.95 .8  	0 0 0 0.01]],
        directional        = true,
        emitrot            = 30,
  ...
  ["explosion_huge_tesla"] = {
    explosionball = {
      ...
      properties = {
        airdrag            = 1,
        colormap           = [[0 0 0 0  0 0.1 0.9 1     0 .12 1 .8    .05 .05 .05 0.7	0 0 0 0.01]],
        directional        = true,
        emitrot            = 30,
        emitrotspread      = [[0 r-360 r360]],
        emitvector         = [[0, 1, 0]],
    ...
    explosionquick = {
      ...
      properties = {
        airdrag            = 1,
        colormap           = [[0 0 0 0  0 0.1 0.9 1    0 .45 1 .01  	0 0 0 0.01]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 360,
        emitvector         = [[0, 1, 0]],
    ...
    explosionring = {
      ...
      properties = {
        airdrag            = 1,
        colormap           = [[0 0 0 0  0 0.1 0.9 1    0 .3 1	 .8  .05 .05 .05 0.7	0 0 0 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 20,
        emitvector         = [[0, 1, 0]],
    ...
    explosionwaterquick = {
      ...
      properties = {
        airdrag            = 1,
        colormap           = [[0 0 0 0  0.1 0.9 1 .8     0.6 .6 1 .8   	0 0 0 0.01]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 360,
        emitvector         = [[0, 1, 0]],
