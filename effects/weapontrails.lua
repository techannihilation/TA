...
return {
  ...
  ["talonstartbursttrail"] = {
    ...
    engine = {
      ...
      water      = true,
      properties = {
        colormap     = [[0.8 1.0 1.0 0.01 0.1 0.2 0.3 0.01 0 0 0 0.01]],
        dir          = [[dir]],
        frontoffset  = 0,
        fronttexture = [[none]],
        length       = -39,
    ...
    smoke = {
      ...
      properties = {
        airdrag             = 0.9,
        colormap            = [[0.05 0.9 1.0 0.01 0.1 0.1 0.1 0.2 0.0 0.0 0.0 0.01]],
        directional         = false,
        emitrot             = 0,
        emitrotspread       = 20,
        emitvector          = [[dir]],
  ...
  ["gokstartbursttrail"] = {
    ...
    smoke = {
      ...
      properties = {
        airdrag             = 0.9,
        colormap            = [[0.78 0.08 0.52 0.01 0.25 0.1 0.1 0.2 0.0 0.0 0.0 0.01]],
        directional         = false,
        emitrot             = 0,
        emitrotspread       = 20,
        emitvector          = [[dir]],
  ...
  ["talonraventrail"] = {
    ...
    engine = {
      ...
      water      = true,
      properties = {
        colormap     = [[0.1 0.9 1.0 0.01		0.05 0.7 0.8 0.01	0 0.25 0.5 0.01]],
        dir          = [[dir]],
        frontoffset  = 0,
        fronttexture = [[none]],
        length       = -33,
    ...
    smoke = {
      ...
      properties = {
        airdrag             = 0.9,
        colormap            = [[0.1 0.9 1 0.01 0.05 0.5 0.75 0.2 0.0 0.0 0.0 0.01]],
        directional         = false,
        emitrot             = 0,
        emitrotspread       = 20,
        emitvector          = [[dir]],
