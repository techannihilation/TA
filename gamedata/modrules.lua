...
local modrules = {
  ...
  movement = {
    ...
    unitQuadPositionUpdateRate = 6;  -- default: 3 
    ...
    groundUnitCollisionAvoidanceUpdateRate = 6;  -- default: 3 
  ...
  system = {
    ...
    qtRefreshPathMinDist = 2000,      -- default: 2000    A larger number reduces CPU usage, but also increses the chance that a unit will become trapped in a complex terrain/base setup even if there's a route that would bring the unit nearer to the goal.
  },
